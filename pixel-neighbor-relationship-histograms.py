...
def greyImageHistogram(image, text, imageWidth, imageHeight):
    greyImage = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY) #Converts image to greyscale and saves to greyImage
    greyList = [] #Initializes list used for tracking difference values 
...
def bgrImageHistogram(image, text, imageWidth, imageHeight):
    bgrList = [] #Initializes list used for tracking difference values 
...
def hsvImageHistogram(image, text, imageWidth, imageHeight):
    hsvImage = cv2.cvtColor(image, cv2.COLOR_BGR2HSV) #Converts image to hsv and saves the hsv image to hsvImage
    hsvList = [] #Initializes list used for tracking difference values 
...
def labImageHistogram(image, text, imageWidth, imageHeight):
    labImage = cv2.cvtColor(image, cv2.COLOR_BGR2LAB) #Converts image to Lab and saves the Lab image to labImage
    labList = [] #Initializes list used for tracking difference values 
...
def main():
    ...
    greyImageHistogram(image, text, imageWidth, imageHeight)
    bgrImageHistogram(image, text, imageWidth, imageHeight)
    hsvImageHistogram(image, text, imageWidth, imageHeight)
    labImageHistogram(image, text, imageWidth, imageHeight)
